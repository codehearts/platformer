...
class TestLoadLevel(unittest.TestCase):
	...
	def test_level_config_translators(self):
		...
		install_level_config_translator('test_c', lambda x: x+test_c_suffix, post=True)
		...
		data_value = translate_data_value('::test_a::::test_c::data')
		...
		data_value = translate_data_value(data_value)
