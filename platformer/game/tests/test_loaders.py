	...
	def test_characters_loader(self):
		...
		test_character_data = [
			...
			# Single character, no gravity
			{
				...
				'expected_results': [
					{
						'get_acceleration': (1, util.get_gravitational_acceleration(bestiary.look_up['test_object_1']['mass'])),
						'get_coordinates': util.tile_to_coordinate(1, 1)
					}
				]
			},
			...
			# Two characters, no gravity
			{
				...
				'expected_results': [
					{
						'get_acceleration': (1, util.get_gravitational_acceleration(bestiary.look_up['test_object_2']['mass'])),
						'get_coordinates': util.tile_to_coordinate(1.5, 3)
					},
					{
						'get_acceleration': (1, util.get_gravitational_acceleration(bestiary.look_up['test_object_3']['mass'])),
